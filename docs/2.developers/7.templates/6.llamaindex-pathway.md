...
To learn more about the possibilities of combining the live indexing pipeline of Pathway and LLMs, check out [real-time RAG alerting with Pathway](https://github.com/pathwaycom/llm-app/tree/main/examples/pipelines/drive_alert) and [ingesting unstructured data to structured](/developers/templates/unstructured-to-structured/).
