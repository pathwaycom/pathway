...
# You should use [Pathway Live Data Framework's output connectors](/developers/user-guide/connect/live-data-framework-connectors) to access the data in streaming mode.
#
...
#
# Although initially designed for static GPS traces, this configuration can easily be adapted for a [streaming setup](/developers/user-guide/introduction/streaming-and-static-modes) by modifying the [connectors](/developers/user-guide/connect/live-data-framework-connectors). In streaming mode, all calculations will be automatically refreshed whenever a new GPS position is received.
