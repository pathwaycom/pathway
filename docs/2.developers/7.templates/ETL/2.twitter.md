---
title: "Real-Time Twitter Sentiment Analysis and Prediction App with Pathway Live Data Framework"
...
# Real-Time Twitter Sentiment Analysis and Prediction App with Pathway Live Data Framework
...
replies to tweets (we will see how this is computed by the Pathway Live Data Framework at the
...
We are going to use the Pathway Live Data Framework to achieve this result. The Pathway Live Data Framework is capable
of handling different sources of live data, including geographical
location data. 

You will now see how the Pathway Live Data Framework can be used to:

-   process a real-time stream of Twitter data,
-   intelligently improve geolocation,
-   perform sentiment analysis.

Thanks to the Pathway Live Data Framework, we can observe trends in real-time - the results are
...
A unique feature of the Pathway Live Data Framework is that previously generated insights are
constantly updated when new data is analyzed. Indeed, as the Pathway Live Data Framework gathers
more and more data, it can update its beliefs about the past. In this
showcase, the Pathway Live Data Framework updates measures of influence of users' Twitter
activity as it is picked up on by others across the globe. The Pathway Live Data Framework also
...
application, let's understand how the Pathway Live Data Framework fits in the final picture. 

![](/assets/content/showcases/twitter/pathway-twitter-app-architecture.png)

The Pathway Live Data Framework is the key technology that performs all the heavy backend
computations for real-time data analysis. 

To ingest data, our Python code sets the Pathway Live Data Framework up to connect via an input
...
To provide outputs, the Pathway Live Data Framework is sending updates to the postgres database
...
### What happens inside the "Pathway Live Data Framework" block?

The code of Pathway Live Data Framework applications is written in Python, and can call upon any
external services and external Machine Learning models of the
programmer's choice. In this way, Pathway Live Data Framework applications fit nicely into the
Python ecosystem. 
...
quality. We add a couple of filters inside the Pathway Live Data Framework to clean erroneous
locations at scale.  

The Python code of Pathway Live Data Framework applications provides for a mix of a data pipeline
...
data goes through a pipeline built in the Pathway Live Data Framework which covers four steps.

### Pipeline step 1: Tweets preprocessing

After connecting a real-time stream of tweets to the Pathway Live Data Framework, we have to
clean them up a little bit. We do this entirely in Python, in
...
single line of code. Then, we can leverage the Pathway Live Data Framework to correct
imperfections in the resulting geolocations from the placeholder
geocoder. 

### Pipeline step 2: Iterative geolocation improvement with Pathway Live Data Framework
...
Indeed, the key differentiator of the Pathway Live Data Framework is that it allows for writing
such iterative workflows!

### Pipeline step 3: Sentiment analysis with Pathway Live Data Framework
...
the [apply](/developers/user-guide/data-transformation/table-operations#operations) function
and calling the [TextBlob](https://textblob.readthedocs.io/en/dev/) library.
The aggregation takes place in another line with a call to the framework's
...
The Pathway Live Data Framework will do that for us. 

That's really it!

### Pipeline step 4: Computing influence with Pathway Live Data Framework
...
one-line "group by" aggregation in the Pathway Live Data Framework! 
...
With the Pathway Live Data Framework it is straightforward to formulate any rule or iterative
algorithm we want - give it a try! 

### Wrapping up

As we have seen, the Pathway Live Data Framework allowed us to express complicated dataflows
...
we highly encourage you to explore the capabilities of the Pathway Live Data Framework on your own
