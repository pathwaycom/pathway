...
### Extract from Kafka
The Pathway Live Data Framework provides [connectors](/developers/user-guide/connect/pathway-connectors) to connect and extract data from different data sources.
