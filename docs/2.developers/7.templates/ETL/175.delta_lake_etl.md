---
title: "Delta Lake ETL with Pathway Live Data Framework for Spark Analytics"
description: "How to use the Pathway Live Data Framework to prepare unstructured data for Spark analytics"
author: 'sergey'
layout: "template"
date: '2024-07-23'
...
# Delta Lake ETL with Pathway Live Data Framework for Spark Analytics
...
The Pathway Live Data Framework provides an efficient way to do ETL with Delta Lake: you can extract and transform data from hundreds of sources and then store it in the Delta Lake format over a local filesystem or S3. Using the Pathway Live Data Framework, you can prepare your data efficiently and maximize the potential of your Spark-based analytics.

In this tutorial, you will learn how to install the Pathway Live Data Framework, configure a data processing pipeline with it, and prepare your data for efficient Spark analytics.
...
The extraction requires configuring the connector for Airbyte. To get the sample configuration for the Airbyte source, you can use the CLI command.
...
The Pathway Live Data Framework provides a connector to write data into Delta Lake, available with the Pathway Live Data Framework Scale and Pathway Live Data Framework Enterprise tiers. You can get a license key from the [Pathway website](https://pathway.com/pricing). After obtaining the key, simply provide it to the `pw.set_license_key` method.
...
In this tutorial, you learned how to do ETL with the Pathway Live Data Framework and Delta Lake by integrating your diverse data sources into this robust ecosystem. The Pathway Live Data Framework is the perfect data extraction and transformation tool for efficient and secure everyday analytics. So, don't hesitate to give it a try!
