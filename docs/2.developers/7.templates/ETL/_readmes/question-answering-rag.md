...
You can find more ready-to-run pipelines in our [templates section](https://github.com/pathwaycom/pathway/blob/main/examples/projects/question-answering-rag//developers/templates?tab=ai-pipelines).
