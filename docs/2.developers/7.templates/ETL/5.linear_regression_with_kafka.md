...
Start doing ML on a streaming data source with the Pathway Live Data Framework.

In this article, we are going to see how to do a simple linear regression on streaming data from Kafka using the Pathway Live Data Framework.
This article can be seen as an extension of our [realtime sum using CSV connectors](/developers/user-guide/introduction/first-realtime-app).
...
For more details on how this connector works, checkout our [example](/developers/user-guide/introduction/first-realtime-app) or the [tutorial](/developers/user-guide/connect/connectors/csv_connectors) about it.
...
As in our [previous example](/developers/user-guide/introduction/first-realtime-app), the outputs are tables of changes.
