...
description: "YAML examples for data sources in Pathway Live Data Framework Templates."
navigation: true
heading: false
toc: true
---
...
You can find all the connectors and learn about how they work and their associated parameters [here](/developers/user-guide/connect/live-data-framework-connectors).
...
#content
The Pathway [SharePoint connector](/developers/api-docs/pathway-xpacks-sharepoint#pathway.xpacks.connectors.sharepoint.read) is available when using one of the following licenses only: [Pathway Live Data Framework Scale, Pathway Live Data Framework Enterprise](/developers/templates/licensing-guide).
