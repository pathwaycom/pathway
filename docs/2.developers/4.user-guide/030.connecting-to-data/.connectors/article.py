...
# Before reading any further, make sure you are already familiar with the [streaming and static modes](/developers/user-guide/connecting-to-data/streaming-and-static-modes/) of Pathway as the connectors are different depending on the chosen mode.
#
...
#                 <span class="block"><a href="/developers/user-guide/connectors/kafka_connectors">Kafka</a></span>
#                 <span class="block"><a href="/developers/user-guide/connectors/csv_connectors">CSV</a></span>
#                 <span class="block"><a href="/developers/user-guide/connectors/database-connectors">Debezium</a></span>
...
#                 <span class="block"><a href="/developers/user-guide/connectors/switching-to-redpanda">Redpanda</a></span>
#                 <span class="block"><a href="/developers/user-guide/connectors/custom-python-connectors">Python</a></span>
...
#                 <span class="block"><a href="/developers/user-guide/connectors/database-connectors">PostgreSQL</a></span>
...
# Whenever an update is received, it is propagated in the dataflow (more details [here](/developers/user-guide/connecting-to-data/streaming-and-static-modes/)) until it reaches the output connectors which output the resulting changes.
...
# * [CSV connectors](/developers/user-guide/connectors/csv_connectors/)
# * [Database connectors](/developers/user-guide/connectors/database-connectors/)
# * [Kafka connectors](/developers/user-guide/connectors/kafka_connectors/)
