...
You need a Pathway Live Data Framework Scale license in order for the scaling to work. You can obtain your free Pathway Live Data Framework Scale license [here](/get-license). The page contains instructions for getting the license and using it in the pipeline.
