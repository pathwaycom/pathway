...
You need to provide a [schema](/developers/user-guide/types-in-pathway/schema/) to the input connector.
...
You can find more information about the available connectors [here](/developers/user-guide/connecting-to-data/connectors).
...
Tables have a static [schema](/developers/user-guide/types-in-pathway/schema/), but their content is dynamic and is updated whenever a new event is received.
...
Pathway comes with many output connectors, you can learn more about them in [our dedicated article](/developers/user-guide/connecting-to-data/connectors/).
...
You can learn more about the streaming and static mode in [our dedicated article](/developers/user-guide/connecting-to-data/streaming-and-static-modes).