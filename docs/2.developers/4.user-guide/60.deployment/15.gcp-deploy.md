---
title: Deploy to GCP
description: 'A guide about how to deploy a Pathway Live Data Framework application to GCP using Google Cloud Run'
---
...
In this article, you will learn how to deploy your Pathway Live Data Framework application to GCP using Cloud Run, a compute platform that lets you run containers on scalable infrastructure. 

The entire process is as easy as deploying any dockerized application.
You will see, step by step, how to deploy a Pathway Live Data Framework web service hosted on a GitHub repository.
...
3. Point to the repository with your application and click the "Next" button.
...
You have successfully deployed a sample Pathway Live Data Framework application using Cloud Run. You can now adjust the pipeline by modifying app.py. 
...
In this guide, you learned how to deploy a Pathway Live Data Framework application to GCP using Cloud Run, from setting up your Google Cloud project to testing and managing your deployment. 
...
Don't hesitate to explore other methods for deploying Pathway Live Data Framework in [our dedicated article](/developers/user-guide/deployment/cloud-deployment).
