...
description: 'A guide about how to deploy the Pathway Live Data Framework using Render'
---

# Deploy with Render: a Step-by-step Guide.

With its full compatibility with Python, deploying with the Pathway Live Data Framework is as easy as deploying any Python project.
...
In this article, you will learn how to deploy your web service using Render.
You will see, step by step, how to deploy a Pathway Live Data Framework web service hosted on a public GitHub repository.
...
This guide will show you how to deploy a Pathway Live Data Framework web service using Render.
...
By being fully Python-compatible, the Pathway Live Data Framework allows you to use all the available tools to deploy your app.
Using tools like Render, deploying your web service app is doable in a few clicks!
Don't hesitate to check out the other ways to deploy the Pathway Live Data Framework in [our dedicated article](/developers/user-guide/deployment/cloud-deployment).
