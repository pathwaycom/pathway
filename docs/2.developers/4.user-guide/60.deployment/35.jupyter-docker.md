...
Jupyter notebooks and Docker are two convenient ways to run Pathway Live Data Framework code.
...
4. Refactor your code: Remove unnecessary code specific to the notebook environment such as the shell commands.
...
The Pathway Live Data Framework comes with its own [Docker image](https://hub.docker.com/r/pathwaycom/pathway).
