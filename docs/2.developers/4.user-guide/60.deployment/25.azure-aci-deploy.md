...
To create the container, start by clicking the **"Create"** button on the listing page. This opens a setup wizard with four steps:
...
The service creation process can take 5-10 minutes to complete. Once finished, you'll see a **"Your deployment is complete"** message. In the **"Next steps"** section, click the **"Go to resource group"** button. From there, navigate to the Kubernetes service linked to the app you configured. Your service is up and running at this point.
