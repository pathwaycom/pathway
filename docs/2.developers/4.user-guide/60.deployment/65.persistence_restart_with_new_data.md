---
title: 'Persistence in Pathway Live Data Framework: How to Add New Data without Full Computation Restart'
description: 'Tutorial on persistence in Pathway Live Data Framework: how to run the finished computation with new inputs added'
...
# Restarting Pathway Live Data Framework Computation with New Data Added
...
First, you need to take care of the input files the engine will parse. You can start by defining the schema. In Pathway Live Data Framework format, its definition looks as follows:
...
With this setup, you can solve the problem with Pathway Live Data Framework and get some initial results.
...
```
    ...
    /usr/local/lib/python3.10/dist-packages/pathway/internals/table.py:1189: UserWarning: Key sets of self and other in update_cells are the same. Using with_columns instead of update_cells.
      warnings.warn(
    [2023-11-29T15:01:32]:INFO:Preparing Pathway Live Data Framework computation
...
```
    ...
    /usr/local/lib/python3.10/dist-packages/pathway/internals/table.py:1189: UserWarning: Key sets of self and other in update_cells are the same. Using with_columns instead of update_cells.
      warnings.warn(
    [2023-11-29T15:01:38]:INFO:Preparing Pathway Live Data Framework computation
...
```
    ...
    /usr/local/lib/python3.10/dist-packages/pathway/internals/table.py:1189: UserWarning: Key sets of self and other in update_cells are the same. Using with_columns instead of update_cells.
      warnings.warn(
    [2023-11-29T15:01:47]:INFO:Preparing Pathway Live Data Framework computation
...
```
    ...
    /usr/local/lib/python3.10/dist-packages/pathway/internals/table.py:1189: UserWarning: Key sets of self and other in update_cells are the same. Using with_columns instead of update_cells.
      warnings.warn(
    [2023-11-29T15:01:52]:INFO:Preparing Pathway Live Data Framework computation
