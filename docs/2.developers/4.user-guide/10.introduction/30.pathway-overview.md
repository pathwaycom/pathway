...
## Going further
Try our [starting examples](/developers/user-guide/introduction/first_realtime_app_with_pathway) or learn more about [the core concepts of the framework](/developers/user-guide/introduction/concepts).
