---
title: "Installation"
description: "Installation page of the Pathway Live Data Framework"
navigation: true
heading: false
toc: false
---
...
To quickly get started with Pathway Live Data Framework, you can install it via pip with the following command:

```
pip install -U pathway
```

It will install all basic dependencies to run your Pathway Live Data Framework pipelines, including our powerful Rust engine.
...
⚠️ Pathway Live Data Framework is available on MacOS and Linux. It is currently not supported on Windows.
...
## Try Pathway Live Data Framework in just a few clicks

Ready to see what Pathway Live Data Framework can do? Try one of our easy-to-run examples!
Available in both notebook and docker formats, these ready-to-launch examples can be launched in just a few clicks.
Pick one and start your hands-on experience with Pathway Live Data Framework today!


::container{.flex .gap-8 .items-center .w-full .justify-center}
    ::pathway-button{href="/developers/user-guide/introduction/first-realtime-app"}
    Starting Example
    ::
...
- For a standard usage of the Pathway Live Data Framework, run `pip install pathway`. It will install the Rust engine and everything required to run the Pathway Live Data Framework. No external LLM-based libraries will be installed.
...
| **SharePoint Connector**  | `pip install "pathway[xpack-sharepoint]"`  | Support for SharePoint  | Requires a (free) [license key](/framework/get-license) |
| **All**        | `pip install "pathway[all]"`   | Install all the optional packages  |  |


## Docker

You can also use Pathway Live Data Framework with Docker.
The official Pathway Live Data Framework Docker image is available on [Docker Hub](https://hub.docker.com/r/pathwaycom/pathway).
...
For more detailed instructions on how to run Pathway Live Data Framework with Docker, please refer to our [dedicated article](/developers/user-guide/deployment/docker-deployment).

## License key

The Pathway Live Data Framework is distributed on a [BSL 1.1 License](https://github.com/pathwaycom/pathway/blob/main/LICENSE.txt) which allows for unlimited non-commercial use, as well as use of the Pathway Live Data Framework package [for most commercial purposes](https://pathway.com/license), free of charge.
...
Some features of Pathway Live Data Framework such as monitoring or advanced connectors (e.g., SharePoint) require a free license key.
To obtain a free license key, you need to register [here](https://pathway.com/get-license).

## Pathway Live Data Framework enterprise package installation
...
### Using Pathway Live Data Framework with enterprise license

To use Pathway Live Data Framework with an enterprise license, obtain the license file from Pathway and set the license key using one of the following methods:
