---
title: "Welcome"
description: "Welcome to the Pathway Live Data Framework developer hub"
navigation: true
heading: false
toc: false
---

# Welcome to Pathway Live Data Framework Developer Documentation!

The Pathway Live Data Framework is a Python data processing framework for analytics and AI pipelines over data streams.
...
#default
    ...
    button:
        ...
        href: '/developers/user-guide/introduction/first-realtime-app'
    ---
    #title
    Getting Started
    ...
    button:
        text: 'Pathway Live Data Framework Templates'
...
## Key Features:
- **Easy-to-use Python API**: Pathway Live Data Framework is fully compatible with Python. Use your favorite Python tools and ML libraries.
...
- **Incremental computations**: using Differential Dataflow, Pathway Live Data Framework takes care of out-of-order data points for you, in real time.
...
- **Easy to deploy** with Docker or Kubernetes. The Pathway Live Data Framework comes with an orchestrator and is fully compatible with OpenTelemetry.
...
- **LLM tooling**: online ML, RAG pipelines, vector indexes... With Pathway Live Data Framework, your ML pipeline works on fresh data.
- **Connect to any data source**: Pathway Live Data Framework comes with 350+ connectors, including SharePoint. Or implement your own.
...
- [Pathway Overview](/developers/user-guide/introduction/live-data-framework-overview)
- [Examples](/developers/user-guide/introduction/first-realtime-app)
- [Core concepts](/developers/user-guide/introduction/concepts)
- [Why Pathway](/developers/user-guide/introduction/why-live-data-framework)
...
## GitHub repository
The Pathway Live Data Framework sources are available on GitHub.
...
## License key
Some features of Pathway Live Data Framework such as monitoring or advanced connectors (e.g., SharePoint) require a free license key. To obtain a free license key, you need to register [here](https://pathway.com/get-license).
