...
description: 'Presentation of Pathway Live Data Framework connectors.'
---

# Connectors in Pathway Live Data Framework

In order to use Pathway Live Data Framework, one of the first things you need to do is to access the data you want to manipulate.
In Pathway Live Data Framework, accessing the data is done using **connectors**.

The Pathway Live Data Framework comes with connectors which connect to external data sources at input, as well as connectors which output the data outside of the framework.
Before reading any further, make sure you are already familiar with the [streaming and static modes](/developers/user-guide/introduction/streaming-and-static-modes) of Pathway Live Data Framework as the connectors are different depending on the chosen mode.
...
<table class="w-full!">
    ...
    <tbody>
        <tr>
            <td class="text-center font-bold align-middle">Input connectors</th>
            <td class="text-center !align-middle">
                ...
                <span class="block"><a href="/developers/api-docs/pathway-io/kinesis">Kinesis</a></span>
                <span class="block"><a href="/developers/api-docs/pathway-io/minio">MinIO</a></span>
                <span class="block"><a href="/developers/user-guide/connect/connectors/mongodb-debezium">MongoDB (with Debezium)</a></span>
                <span class="block"><a href="/developers/api-docs/pathway-io/mongodb">MongoDB (with oplog replication)</a></span>
                <span class="block"><a href="/developers/api-docs/pathway-io/mongodb">MongoDB Atlas</a></span>
                <span class="block"><a href="/developers/api-docs/pathway-io/mqtt">MQTT</a></span>
                <span class="block"><a href="/developers/api-docs/pathway-io/mssql">MS SQL Server</a></span>
                <span class="block"><a href="/developers/api-docs/pathway-io/nats">NATS</a></span>
                <span class="block"><a href="/developers/user-guide/connect/connectors/neondb-connector">NeonDB</a></span>
                <span class="block"><a href="/developers/api-docs/pathway-io/plaintext">Plain text</a></span>
                <span class="block"><a href="/developers/api-docs/pathway-io/postgres">PostgreSQL (via WAL reading)</a></span>
                <span class="block"><a href="/developers/api-docs/pathway-io/pulsar">Pulsar</a></span>
        ...
        <tr>
            <td class="text-center font-bold align-middle">Output connectors</th>
            <td class="text-center !align-middle">
                <span class="block"><a href="/developers/api-docs/pathway-io/bigquery">BigQuery</a></span>
                <span class="block"><a href="/developers/api-docs/pathway-io/chroma">Chroma</a></span>
                <span class="block"><a href="/developers/api-docs/pathway-io/clickhouse">ClickHouse</a></span>
                <span class="block"><a href="/developers/user-guide/connect/connectors/csv_connectors">CSV</a></span>
                <span class="block"><a href="/developers/api-docs/pathway-io/deltalake">Delta Lake</a></span>
                <span class="block"><a href="/developers/api-docs/pathway-io/duckdb">DuckDB</a></span>
                ...
                <span class="block"><a href="/developers/api-docs/pathway-io/milvus">Milvus</a></span>
                <span class="block"><a href="/developers/api-docs/pathway-io/mongodb">MongoDB</a></span>
                <span class="block"><a href="/developers/api-docs/pathway-io/mongodb">MongoDB Atlas</a></span>
                <span class="block"><a href="/developers/api-docs/pathway-io/mqtt">MQTT</a></span>
                <span class="block"><a href="/developers/api-docs/pathway-io/mssql">MS SQL Server</a></span>
                <span class="block"><a href="/developers/api-docs/pathway-io/mysql">MySQL</a></span>
                <span class="block"><a href="/developers/api-docs/pathway-io/nats">NATS</a></span>
                <span class="block"><a href="/developers/user-guide/connect/connectors/neondb-connector">NeonDB</a></span>
                <span class="block"><a href="/developers/api-docs/pathway-io/postgres">pgvector</a></span>
                <span class="block"><a href="/developers/api-docs/pathway-io/pinecone">Pinecone</a></span>
                <span class="block"><a href="/developers/user-guide/connect/connectors/database-connectors">PostgreSQL</a></span>
                <span class="block"><a href="/developers/api-docs/pathway-io/pulsar">Pulsar</a></span>
                <span class="block"><a href="/developers/api-docs/pathway-io/qdrant">Qdrant</a></span>
...
As Pathway Live Data Framework deals with never-ending streaming data: the computation runs forever until the process gets killed.
**This is the normal behavior of the framework.**

Output connectors are the only way to access the results obtained in the streaming mode.
...
To see how to set up a realtime streaming application with Pathway, you can try our examples with [csv](/developers/user-guide/introduction/first-realtime-app) and [Kafka](/developers/templates/etl/linear_regression_with_kafka) input connectors.
...
In addition of a csv connector which dumps the output table into a csv file, Pathway Live Data Framework provides a function which allows to build the graph, to ingest all the data and to print a given table contained in the graph: `pw.debug.compute_and_print`.
...
Connectors are a vital part of the Pathway Live Data Framework as they define how your data is accessed to and from the framework.
...
The Pathway Live Data Framework provides several connectors, allowing you to connect to your data in different settings in a simple and efficient way.
