...
With the [`demo`](/developers/api-docs/pathway-demo) module, you can create custom data streams from scratch or by utilizing a CSV file.
This feature empowers you to effectively test and debug your Pathway Live Data Framework implementation using realtime data.

The Pathway Live Data Framework offers a seamless transition from static to streaming data.
...
This function is named after the sum example of the [first realtime app guide](/developers/user-guide/introduction/first-realtime-app):
...
Fortunately, the `demo` module comes to the rescue, offering a seamless solution to create custom data streams from scratch or from existing CSV files.
You can now test and debug your Pathway Live Data Framework implementation with real-time data, providing you with invaluable insights and boosting your application's performance.
