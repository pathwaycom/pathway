...
In this article, you will learn how to switch from Kafka to Redpanda and how to adapt your Pathway Live Data Framework project to Redpanda.
The change is easier than you might think: your code remains the same!
...
---
--- 
Spoiler Alert 🚨 Pathway Live Data Framework works with both Kafka and Redpanda fully transparently: you don't have to change anything in your code. 
---
::

If you already have your Pathway Live Data Framework project deployed and want to switch to an existing Redpanda instance, you can jump directly to the [Redpanda section](/developers/user-guide/connect/connectors/switching-to-redpanda#switching-to-redpanda).
...
Now you have a stream generated from the dataset and sent to Kafka, so at this point you simply need to connect Pathway Live Data Framework to Kafka and process the data.
...
You must now connect Pathway Live Data Framework and the stream producer to `redpanda` instead of `kafka`.
...
As with Pathway Live Data Framework, you need to update the server name (if required) for the stream generator:
...
Note that this difference comes from Redpanda and not Pathway Live Data Framework.
Pathway Live Data Framework connects to Redpanda and Kafka totally transparently.
Pathway Live Data Framework will receive and process the data the same way whether Kafka or Redpanda is used.
...
You've successfully computed the *K* best-rated movies using Redpanda, and your ranking is automatically updated thanks to Pathway Live Data Framework;
...
Connecting to Redpanda with Pathway Live Data Framework is as easy as connecting to Kafka.
...
Congratulations! 🎉 You have built a K-best-rated application in Pathway Live Data Framework and made it work with Redpanda.
Being fully Kafka API-compatible, Redpanda just works: if the server name remains the same, you have nothing to do with your code!
For consistency, you can use the Redpanda connectors which work exactly the same as Kafka connectors.
