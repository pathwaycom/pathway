...
This tutorial will guide you through connecting Pathway Live Data Framework to your data stored on Google Drive.
...
To enable access to your Google Drive files through a Pathway Live Data Framework app, you'll require a Google Cloud project and a service user. 
...
A JSON file will be saved to your computer. Move it to the folder where your Pathway Live Data Framework script is located and rename it to `credentials.json`.
...
## Connecting to Google Drive with Pathway Live Data Framework
