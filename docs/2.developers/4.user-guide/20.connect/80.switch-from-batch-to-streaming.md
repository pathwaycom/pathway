...
description: 'How to switch from batch to streaming with Pathway Live Data Framework'
---


# Switching from Batch to Streaming
Easily switching from batch to streaming is a core feature of the Pathway Live Data Framework.
...
Good news for you, Pathway Live Data Framework makes it extremely easy as it is a **unified batch and streaming processing framework**.

In a nutshell, the only thing you need to do is to change your data sources to connect to your streaming data sources, and Pathway Live Data Framework will take care of the rest!
...
In Pathway Live Data Framework, this change is very easy: **you simply need to change the connectors to connect to your streaming data sources**.
...
Not much: Pathway Live Data Framework will handle everything for you.
You don't have to worry about the new temporal nature of your project: Pathway Live Data Framework will manage late and out-of-order data points for you.

In a streaming system, inputs are coming as a never-ending data stream, so Pathway Live Data Framework computes an output with the available data and then revises the result whenever new data arrives.
This is the only real change when switching to streaming: **now the output is not a static result but a data stream**.
Whenever a new update, a new CSV file in our example, is coming, the new values are ingested by Pathway Live Data Framework and the results are automatically updated.
You can take a look at our [first-steps article](/developers/user-guide/introduction/first-realtime-app#understanding-the-output) to understand the new results.
...
As you can see, Pathway Live Data Framework makes the transition between batch to streaming as easy as possible.
Using Pathway Live Data Framework, you can now focus on building your pipeline on static data, without worrying about the temporal nature of your data.
Once ready, simply change your connectors to connect to your live data sources and let Pathway Live Data Framework manage everything for you.
