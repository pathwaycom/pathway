...
# Troubleshooting
This page provides a guide to common issues encountered when using Pathway Live Data Framework.

As with any powerful tool, there is a learning curve to using Pathway Live Data Framework effectively.
This guide will outline some of the most common problems developers encounter when working with Pathway Live Data Framework, along with tips and best practices for avoiding these pitfalls.
Whether you are new to Pathway Live Data Framework or an experienced user, this guide will help you to optimize your workflow and avoid common mistakes.
By following these guidelines, you can save yourself time and frustration and get the most out of Pathway Live Data Framework.
...
## Package versioning
If a module is missing or you encounter an issue reproducing the examples displayed on the website, you will likely need the latest version of the `pathway` package.
The best solution is to reinstall it.

⚠️ Pathway Live Data Framework requires Python 3.10 or higher and runs on Linux and MacOS.
...
⚠️ Pathway Live Data Framework is currently not supported on Windows.
...
You launch your application, and nothing happens: no outputs, no errors.
...
Explanation:
 - The operators in Pathway Live Data Framework are used to build a pipeline modeled by a [dataflow](/developers/user-guide/introduction/concepts#dataflow).
...
Similarly to above, you launch your application, and nothing happens.
...
We hope this guide has helped identify and avoid common mistakes when using Pathway Live Data Framework.
Our team is always happy to help you find a solution to your problem and ensure that you get the most out of Pathway Live Data Framework.
