...
The LLM xpack provides you all the tools you need to use Large Language Models in Pathway Live Data Framework. Wrappers for most common LLM services and utilities are included, making working with LLMs as easy as it can be.
...
### Creating a Pathway Live Data Framework LLM pipeline
You can now combine these wrappers to create an LLM pipeline using Pathway Live Data Framework. To learn how to do this, read [our tutorial](/developers/user-guide/llm-xpack/llm-app-pathway).
