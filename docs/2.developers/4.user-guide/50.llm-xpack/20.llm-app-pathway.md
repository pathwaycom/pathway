...
You need to ingest them into the pipeline using [Pathway Live Data Framework connectors](/developers/user-guide/connect/connectors-in-pathway).
...
```
You can find the list of Pathway Live Data Framework connectors [here](/developers/user-guide/connect/pathway-connectors).
