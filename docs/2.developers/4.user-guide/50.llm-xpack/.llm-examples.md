---
title: 'LLM Examples'
description: 'LLM examples made with Pathway Live Data Framework LLM tooling'
tags: ['tutorial', 'LLM']
...
With the LLM tooling provided by Pathway Live Data Framework, building LLM and RAG pipelines have become easy.
If you want to see how it works, this page gathers practical examples using Pathway Live Data Framework LLM tooling.
    ...
    <tbody>
        <tr>
            <td class="text-center">
                <a href="https://github.com/pathwaycom/llm-app/tree/main/templates/question_answering_rag">Pathway Live Data Framework RAG app with always up-to-date knowledge</a>
            </td>
            <td class="text-center">
