...
description: 'Tutorial on connecting the MCP Server to Claude Desktop for real-time data access'
date: '2025-08-19'
thumbnail: ''
...
# Using Pathway Live Data Framework MCP Server with Claude Desktop
...
By connecting **[Pathway Live Data Framework MCP Server](/developers/user-guide/llm-xpack/live-data-framework-mcp-server)** to **[Claude Desktop](https://claude.ai/download)**, you can provide Claude with all Pathway Live Data Framework data processing capabilities, including real-time access to statistics and document stores.

This tutorial explains how to set up and use the MCP Server with Claude Desktop, allowing Claude to retrieve real-time data, perform computations, and interact with your document store.
...
::note
**Important**: The MCP Server requires a Pathway Live Data Framework license key. You can obtain a free license key [here](/framework/get-license).
::

## MCP Servers

MCP servers act as intermediaries between AI applications (like Claude Desktop) and data sources and tools.
The MCP Server provides the real-time data processing capabilities of the engine to your AI applications, such as:
...
You can learn more about the MCP server in the [associated article](/developers/user-guide/llm-xpack/live-data-framework-mcp-server).
...
Other MCP server examples are available [here](/developers/user-guide/llm-xpack/live-data-framework-mcp-server).
...
To be able to use your MCP Server in Claude Desktop do as follows:
...
Reload Claude Desktop configuration with Ctrl+R and Claude Desktop will connect to your MCP Server.
...
provider: 's3'
alt: 'If everything went well, the MCP server should be listed in the Developer section.'
class: 'mx-auto mt-16 mb-8'
---
::

## Using the MCP Server with Claude
You can now ask Claude to use the tools exposed by the MCP Server. For example:
...
The Pathway Live Data Framework should be listed as a tool in the chat:

::article-img
---
src: '/assets/content/documentation/claude-desktop/claude-desktop-pathway-server.png'
provider: 's3'
alt: 'Pathway Live Data Framework should be listed as a tool in the chat.'
class: 'mx-auto mt-16 mb-8'
---
::
...
To use other tools, you can implement some presented in the [MCP article](/developers/user-guide/llm-xpack/live-data-framework-mcp-server).
Restart your MCP server, and reload Claude Desktop: the configuration stay the same, you have nothing else to do!

## Conclusion
By connecting the MCP Server to Claude Desktop, you enable Claude to access real-time data, perform computations, and interact with your tables.
You can easily set up a RAG pipeline by [exposing the Document Store](/developers/user-guide/llm-xpack/live-data-framework-mcp-server#exposing-pathway-document-store).
...
As real-time data processing becomes increasingly important, tools like the MCP Server will be essential for effective data handling and decision-making in AI applications.
