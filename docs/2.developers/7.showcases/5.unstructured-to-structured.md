...
article:
  ...
  tags: ['showcase', 'llm']
keywords: ['LLM', 'SQL', 'unstructured', 'PostgreSQL', 'GPT', 'Entity extraction', 'Document parsing', 'JSON', 'unstructured']
---
...
To run it, a simple `python app.py` should do the trick. It is also possible to run with Docker, see the [llm-app repository](https://github.com/pathwaycom/llm-app/) for details. 
