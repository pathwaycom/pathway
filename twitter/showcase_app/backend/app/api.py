...
async def read_impact(start: int, end: int) -> dict:
    ...
    FROM (
        SELECT
            ...
            SUM(tweet_to_sentiment) / SUM(responses_count) as mean_sentiment,
    ...
    FULL OUTER JOIN author_meta ON
        agg.tweet_to_author_id = author_meta.tweet_to_author_id
    """

    # todo mean_sentiment should probably come from tweet_from_sentiment and not tweet_to_sentiment
