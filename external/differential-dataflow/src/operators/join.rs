...
use lattice::Lattice;
use operators::arrange::{ArrangeByKey, ArrangeBySelf, Arranged};
use operators::ValueHistory;
use trace::{BatchReader, Cursor};
use {AsCollection, Collection, Data, ExchangeData};
    ...
    Tr::R: Semigroup,
{
    fn join_map<V2: ExchangeData, R2: ExchangeData + Semigroup, D: Data, L>(
        &self,
        other: &Collection<G, (Tr::Key, V2), R2>,
        mut logic: L,
    ) -> Collection<G, D, <Tr::R as Multiply<R2>>::Output>
    where
        Tr::Key: ExchangeData,
        Tr::R: Multiply<R2>,
        <Tr::R as Multiply<R2>>::Output: Semigroup,
        L: FnMut(&Tr::Key, &Tr::Val, &V2) -> D + 'static,
    {
        let arranged2 = other.arrange_by_key();
    ...
    fn semijoin<R2: ExchangeData + Semigroup>(
        &self,
        other: &Collection<G, Tr::Key, R2>,
    ) -> Collection<G, (Tr::Key, Tr::Val), <Tr::R as Multiply<R2>>::Output>
    where
        Tr::Key: ExchangeData,
        Tr::R: Multiply<R2>,
        <Tr::R as Multiply<R2>>::Output: Semigroup,
    ...
    fn antijoin<R2: ExchangeData + Semigroup>(
        &self,
        other: &Collection<G, Tr::Key, R2>,
    ) -> Collection<G, (Tr::Key, Tr::Val), Tr::R>
    where
        Tr::Key: ExchangeData,
        Tr::R: Multiply<R2, Output = Tr::R>,
        Tr::R: Abelian,
    {
