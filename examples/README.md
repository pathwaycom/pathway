# Pathway Live Data Framework examples

This repository contains examples of data processing using [Pathway Live Data Framework](https://pathway.com/developers/documentation/introduction/welcome), the Python-based programming framework for easy building of realtime and reactive data products.
...
- Build an LLM App with Pathway Live Data Framework ([GitHub](https://github.com/pathwaycom/llm-app/tree/main)).
- Realtime Twitter Analysis App with Pathway Live Data Framework ([GitHub](https://github.com/pathwaycom/pathway/tree/main/examples/projects/twitter)).
...
Don't hesitate to look for help on [our website](pathway.com/developers/user-guide/development/get-help/) or directly on the [main repo of the Pathway Live Data Framework package](https://github.com/pathwaycom/pathway).
