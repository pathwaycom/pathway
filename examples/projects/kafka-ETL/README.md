...
In this project, you build an ETL pipeline with Pathway Live Data Framework with Kafka in and Kafka out.
Two data sources broadcast date times with different time zones to different Kafka topics.
The Pathway Live Data Framework connects to those topics, extracts (E) the data, transforms (T) the date times
...
The project is organized as follows:
 ...
 - a Python container doing the ETL using the Pathway Live Data Framework, sending the results back to Kafka
...
provided in the container running the Pathway Live Data Framework.
Do as follows:
...
The Pathway Live Data Framework reads the incoming data and outputs it in the `results.csv` file.
